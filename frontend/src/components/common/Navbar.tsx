...
const Navbar = ({ isDashboard = false }: NavbarProps) => {
  ...
  return (
    <div className={cn(
      isDashboard ? "h-14 flex items-center bg-surface border-b border-border-subtle shrink-0 md:px-6 lg:px-8" : "sticky top-0 z-50 w-full transition-all duration-300 border-b",
      ...
      {isDashboard ? (
        <div className="w-full flex h-14 items-center justify-between gap-4 px-4">
          {/* Dashboard Left: Search */}
